...
import { GeneralSettingsPayload_default } from "./data/data.GeneralSettingsDefaultPayload";
...
export const GeneralSettings_LoadArgs = async (eGeneralSettings: EntityGeneralSettings): Promise<IGeneralSettingsData> => {
    ...
    const loadedGeneralSettingsProps: GeneralSettingsPayload = GeneralSettingsPayload_default;
    const cardType =
    ...
    const newGeneralSettingsProps : GeneralSettingsPayload = { 
        ...
        paxsettings: {
            ...
            pax_application_version: eGeneralSettings.CreditCard?.Pax?.PaxApplicationVersion ?? loadedGeneralSettingsProps.paxsettings?.pax_application_version ?? '1.0.0',
        ...
        payfac: {
            ...
            pf_payfac_custom_tips: eGeneralSettings.CreditCard?.PayFac?.CustomTips?.enable ?? loadedGeneralSettingsProps.payfac?.pf_payfac_custom_tips ?? false,
        ...
        giftcardenable: eGeneralSettings.GiftCards?.Enable ?? loadedGeneralSettingsProps.giftcardenable ?? false,
        giftcards: {
            giftcard_account_email: eGeneralSettings.GiftCards?.Email ?? "alpha@bottlepos.com",
            giftcard_apikey: eGeneralSettings.GiftCards?.Password ?? "113|JkvcpAcjwZIevYpduq5ntSOXZRYEXmJ2ws4wHCi91aefc02b",
            giftcard_expiration: "never",
            giftcard_itemid: eGeneralSettings.GiftCards?.ItemId ?? "163",
        }
    }
