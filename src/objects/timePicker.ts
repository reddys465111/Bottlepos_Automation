...
export class TimePicker extends BaseObject {
    ...
    //     await this._timePickerLocator.locator(`.clockpicker-hours`).locator(`//*[@class="clockpicker-tick"][text()="${hour}"]`).click();
    // }
    private async selectHour(hour: string): Promise<void> {
    ...
    //     await this._timePickerLocator.locator(`.clockpicker-minutes`).locator(`//*[@class="clockpicker-tick"][text()="${minute}"]`).click();
    // }
    private async selectMinute(minute: string): Promise<void> {
    ...
    //     await this._timePickerLocator.locator(`.clockpicker-am-pm-block .${period.toLowerCase()}-button`).click();
    // }
    private async selectPeriod(period: 'AM' | 'PM'): Promise<void> {
