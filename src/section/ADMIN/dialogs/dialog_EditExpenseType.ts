...
export class Dialog_EditExpenseType extends Legacy_BaseDialog {
    ...
    constructor(page: Page) {
        super(page, "Edit Exppense Type");
        this.Name = new TextField(this._locator.locator('#expensetypename'));
