...
export class Dialog_EditItem extends Legacy_BaseDialog{
    ...
    constructor(page: Page){
        super(page, page.locator('[aria-describedby="editdialog"]'));
        this.Details = {
            ...
            Supplier : new Dropdown(this._locator.locator('#itemsupplier')),
