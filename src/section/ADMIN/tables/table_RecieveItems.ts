...
export type Titles = 'Stock Code' | 'Name' | 'ItemRank' | 'Qty on Hand' | 'Received Case' | 'Unit Per Case' | 'Received Bottles' | 'Total Cost' | 'Cost Per Bottle' | 'Price' | 'Margin' | 'Margin Change' | 'Vendor Item No.';

export class Table_ReceiveItems extends BaseTable<Titles> {
...
public async AddItem(): Promise<void> {
  await this._locator.locator(".action-btns a .icon-plus").click();  // Add item button
