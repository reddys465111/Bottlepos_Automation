...
test.describe('Age Verification Workflow Tests', { tag: ['@age_verification', '@regression', '@pos'] }, () => {
    ...
    test('[C112266] As a cashier, I want to complete a transaction with age verification so that I can sell age-restricted items', { tag: ['@age_verification_workflow', '@critical', '@noID'] }, async ({}) => {
