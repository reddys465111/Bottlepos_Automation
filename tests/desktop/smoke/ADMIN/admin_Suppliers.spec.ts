...
test.describe('Admin Section', {tag: ['@smoke']}, () => {
    test('[C1422] Add new supplier in admin portal', { tag: ['@uncategorized', '@debug'] },  async ({}) => {
        const supplier = {
        ...
        await ADMIN.Suppliers.Table.SortBytableColumn({columnIndex: 1, sortOrder: 'descending'});
