...
test.describe("Admin Section - Dashboard", { tag: ['@smoke', '@admin', '@dashboard', '@nonparallelizable'] }, () => {

  test('[T10728] Admin: Realtime dashboard elements are fully functional', { tag: ['@stats'] }, async ({ }) => {
  ...
  test("[C10736] filter top-selling items by Rank category.", { tag: ['@noID'] }, async () => {
  ...
  test("[C10737] Validate structure and data of Top Rank Items table", { tag: ['@rank', '@noID'] }, async () => {
    await ADMIN.Login.In();
