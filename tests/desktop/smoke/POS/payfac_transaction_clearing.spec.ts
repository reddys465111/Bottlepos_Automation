...
test.describe('PayFac Transaction Clearing', { tag: ['@smoke', '@payfac', '@register'] }, () => {
    ...
    test('[C1234] As an admin, I want to verify cart clears after PayFac payment so that register is ready for next customer', { tag: ['@payment', '@cart_clearing', '@noID'] }, async ({}) => {
