...
test.describe("Scenarios related to Promotions", { tag: ['@mobile', '@cash', '@promotion', '@smoke'] }, () => {

    test.skip('[C293-1] Verify Promotion Application on an Item ', { tag: ['@enabled'] }, async ({}) => {
    ...
    test('[C1158-1] Verify Disabled Promotion Status Prevents Application ', { tag: ['@notapplied'] }, async ({}) => {
        //Login to the POS application
        await POS.Login.In();
        //Enter the barcode of an item and hit enter, item will be ringed up
        //In this case the item category has age verification enabled
